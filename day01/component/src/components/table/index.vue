  ...
  <div>
    <el-table
      ...
      <template v-for="(item,index) in column">
        <el-table-column v-if="item.type === 'function'" :key="index" :label="item.label" :prop="item.prop"
                         :width="item.width">
        ...
        <el-table-column v-if="item.type === 'slot'" :key="index" :label="item.label" :prop="item.prop"
                         :width="item.width">
          <template v-slot="scope">
            <slot :data="scope.row" :name="item.slot_name"></slot>
          </template>
        </el-table-column>
        <el-table-column v-else :key="index" :label="item.label" :prop="item.prop"
  ...
  methods: {
    async getTableList() {
      ...
      try {
        ...
        if (this.format && typeof this.format === 'fuction') {
